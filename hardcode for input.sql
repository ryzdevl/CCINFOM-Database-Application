...
('R102', 'Deluxe', 'Queen', 2, 150.00, 'available', 'Spacious room with queen bed and balcony'),
('R103', 'Suite', 'King', 4, 250.00, 'available', 'Luxury suite with ocean view and living area'),
('R104', 'Standard', 'Twin', 2, 90.00, 'available', 'Twin bed room perfect for friends'),
('R105', 'Deluxe', 'King', 2, 180.00, 'available', 'Premium room with king bed'),
('COTT-01', 'Cottage', 'King', 4, 300.00, 'available', 'Private beach cottage with kitchenette'),
